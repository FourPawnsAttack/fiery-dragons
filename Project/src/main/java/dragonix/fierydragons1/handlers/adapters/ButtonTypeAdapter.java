...
/**
 * The ButtonTypeAdapter class is a Gson TypeAdapter for serializing and deserializing Button objects.
 * It serializes a Button object to its ID and deserializes a String ID to a Button object.
 */
public class ButtonTypeAdapter extends TypeAdapter<Button> {
    /**
